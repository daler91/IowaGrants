...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_grant_title_trgm ON "Grant" USING GIN (title gin_trgm_ops);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_grant_description_trgm ON "Grant" USING GIN (description gin_trgm_ops);
