...
export default function AdminPage() {
  ...
  return (
    <div>
      ...
      {admin && <p className="text-[var(--muted)] mb-8">Logged in as {admin.email}</p>}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Link
          ...
          className="bg-[var(--card)] rounded-lg border border-[var(--border)] p-6 hover:shadow-md transition-shadow"
        >
          <h2 className="text-xl font-semibold text-[var(--foreground)] mb-2">URL Blacklist</h2>
        ...
        <Link
          ...
          className="bg-[var(--card)] rounded-lg border border-[var(--border)] p-6 hover:shadow-md transition-shadow"
        >
          <h2 className="text-xl font-semibold text-[var(--foreground)] mb-2">Invite Admins</h2>
          <p className="text-[var(--muted)]">
